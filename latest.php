...
<!-- hero section -->
 <div class="latest-hero mb-5">
 <div class="latest-text position-relative">
          <h1 class="display-1 mb-4 ">Resources on Matters Teens</h1>
   ...
   <div class="container d-flex justify-content-between">
    <div><p class="fs-1"><i class="fa fa-video latest-icon"></i>Videos</p></div>
<a href="video.php"><div><button  class="button px-3" style="font-size:24px">View All <i class="fa fa-angle-double-right"></i></button></div></a>
   </div>
...
<div class="row">
    ...
    <!-- podcast section -->
    <div class="container d-flex justify-content-between">
    <div><p class="fs-1"><i class="fa fa-microphone pe-3 fs-1  latest-icon"></i>Podcasts</p></div>
  <a href="podcast.php">  <div><button  class="button px-3" style="font-size:24px">View All <i class="fa fa-angle-double-right"></i></button></div></a>
   </div>
    <div class="container my-5">
<div class="row">
    <div class="col">
    <div class="card h-100">
        <img src="/assets/images/podcast_timazi_story.png" class="img-fluid p-4">
        <div class="card-body">
            <div class="card-title ps-4">
                <h2>Christ vs Tribal gods</h2>
                <div class="card-text">
                <p  class="card-text lh-lg fs-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et iure esse soluta delectus nesciunt molestiae
                quod consequatur? Quam, optio possimus?...</p>
                </div>
                <div class="card-link">
                <a href="" class="card-link fs-5">Go to Video<i class="fa fa-arrow-circle-right ps-3 text-black fs-4 "></i> </a>
        </div>
    ...
    <div class="col">
    <div class="card h-100">
        <img src="/assets/images/podcast-in-search-of-sanity-musinginzi.png" class="img-fluid p-4">
        <div class="card-body">
            <div class="card-title">
                  <h2>The Battle For This Generation</h2>
                <div class="card-text">
                <p  class="card-text lh-lg fs-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed 
    ...
    <div class="col">
    <div class="card h-100">
        <img src="/assets/images/podcast_Godly_generation.png" class="img-fluid p-4">
        <div class="card-body">
            <h2  class="card-title">The Mystery of The Inclusion of Gentiles</h2>
            <p  class="card-text lh-lg fs-4">Lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum...</p>
                <a href="" class="card-link fs-5">Go to Video<i class="fa fa-arrow-circle-right ps-3 text-black fs-4 "></i> </a>
        </div>
    </div>
    </div>
    ...
    <!-- articles section -->
    <div class="container d-flex justify-content-between">
    <div><p class="fs-1"><i class="fa fa-file fs-3 pe-3 latest-icon"></i>Articles</p></div>
   <a href="article.php"> <div><button  class="button px-3" style="font-size:24px">View All <i class="fa fa-angle-double-right" ></i></button></div></a>
   </div>
    <div class="container my-5">
<div class="row">
    <div class="col">
